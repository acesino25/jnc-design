...
### AI Prompt: Running a Design System as a Product

> Paste this as context before asking any question about design system operations, team structure, versioning, or scaling.
...
CENTRALIZED
  ...
  All component proposals, builds, and releases go through them.
...
DISTRIBUTED
  ...
  No single source of truth, minimal shared governance.
...
DESIGN
  Figma — primary design tool (dominant in all modern systems).
...
DEVELOPMENT
  ...
  Sass/SCSS — token generation and static stylesheets.
...
TEAM SATISFACTION (NPS)
  ...
  One question: "How likely are you to recommend the design system?"
...
Tokens in Name Only
  ...
  hex values in practice. Audit regularly. Enforce with linting (stylelint-plugin-design-tokens).

The Frozen System
  No contributions accepted. No updates shipped.
  Design system teams that stop shipping lose credibility and adoption.
  Aim for at least one patch release every two weeks.

Version Lock
  Consuming teams stuck on v1 while the system is at v4.
  Root cause: no codemods, insufficient migration support, too many breaking changes.
