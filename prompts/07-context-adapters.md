...
### AI Prompt: Industry & Product-Type Specific Design Guidance

> Paste this as context when designing for a specific industry or product type. Specify your context at the start of your question.
...
Reference systems: IBM Carbon, Salesforce Lightning, SAP Fiori, 
Atlassian, Elastic UI, GitLab Pajamas, GitHub Primer
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- High-contrast semantic colors: danger red must be unmistakable.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ADAPTER B — CONSUMER & E-COMMERCE
Reference systems: Shopify Polaris, Duolingo, Airbnb, Gestalt (Pinterest)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- Emotion through color — warmth, energy, or calm as brand dictates.
...
- Reminder patterns: push notifications for habit-forming products.
...
Reference systems: GOV.UK Design System, USWDS, Australian Government DS,
Digital NSW, .it Designers Italy
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

MINDSET: One system for everyone. The most inclusive writing and design possible.
...
- Test copy with real users from diverse literacy backgrounds.
...
- Resist per-department visual divergence. One system = one government.
- Component additions require system-wide review, not local overrides.
- Document every exception and the justification for it.
...
Reference systems: AXA Digital, E-Trade Design Language, 
Finastra, Carbon (IBM) for financial use cases
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- Every claim may require legal/compliance review. Write accordingly.
...
- Charts, timelines, and portfolio views are primary components.
...
- Support for accessibility: older users, motor impairments, low vision.

TOKENS
- Conservative color palette. Limited hues. High contrast.
- Tabular number font variant on all numerics.
- Strong elevation for transaction flows and multi-step modals.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ADAPTER E — DEVELOPER TOOLS & PLATFORMS
Reference systems: GitHub Primer, GitLab Pajamas, Elastic UI, 
Grafana UI, Base Web (Uber)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- Many developers live in dark mode full-time.
...
- Charts must use color-blind-safe palettes (not red/green only).
- Categorical colors must be distinguishable in grayscale.
- Hover/click states on all data points with exact values.
- Export data as CSV/JSON from any chart.
...
Reference systems: BBC GEL, FutureLearn, Discovery Education Comet
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- Type scale must go large — Display sizes for editorial impact.

IMAGE & MEDIA SYSTEMS
- Aspect ratio tokens for all image contexts (16:9, 4:3, 1:1, 21:9).
- Art direction rules: focal point guides, overlay text legibility rules.
...
- Bookmarking / save-for-later as a primary feature.

LIVE / REAL-TIME PATTERNS
- Live badge (animated red dot) for real-time broadcasts.
- Countdown timers for scheduled content.
- Auto-refresh with user notification ("3 new articles") not silent refresh.

RESTRAINED UI PALETTE
- UI chrome should fade into the background. Content (images, video) is the hero.
