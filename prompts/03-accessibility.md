...
### AI Prompt: Inclusive Design, WCAG, ARIA, Keyboard & Screen Reader Patterns

> Paste this as context before asking any question about accessibility.
...
6. Motion
   ...
   CSS pattern:
     @media (prefers-reduced-motion: reduce) {
       ...
       /* OR use opacity-only transitions ≤ 0.3s */
